...
class MultiGraph:
    ...
    edges: Any
    degree: Any
    adj: dict[Any, dict[Any, dict[int, dict[str, Any]]]]
    name: str
    ...
    def remove_nodes_from(self, nodes: Any) -> None: ...
    def add_edge(
        self, u: Any, v: Any, key: Optional[int] = None, **attr: Any
    ) -> int: ...
    def add_edges_from(self, ebunch_to_add: Any, **attr: Any) -> None: ...
    def add_weighted_edges_from(
        self, ebunch_to_add: Any, weight: str = "weight"
    ...
    def clear_edges(self) -> None: ...
    def has_node(self, n: Any) -> bool: ...
    def has_edge(self, u: Any, v: Any, key: Optional[int] = None) -> bool: ...
    def neighbors(self, n: Any) -> list[Any]: ...
    def adjacency(self) -> dict[Any, dict[Any, dict[int, dict[str, Any]]]]: ...
    def copy(self) -> "MultiGraph": ...
    def subgraph(self, nodes: Any) -> "MultiGraph": ...
    def edge_subgraph(self, edges: Any) -> "MultiGraph": ...
    def to_undirected(self) -> "MultiGraph": ...
    def to_directed(self) -> None: ...
    def update(self, edges: Any = None, nodes: Any = None) -> None: ...
    def number_of_edges_between(self, u: Any = None, v: Any = None) -> int: ...
    def __len__(self) -> int: ...
    def __contains__(self, n: Any) -> bool: ...
    def __iter__(self) -> Iterator: ...
    def __getitem__(self, n: Any) -> dict[Any, dict[int, dict[str, Any]]]: ...
    def __bool__(self) -> bool: ...
...
class MultiDiGraph:
    ...
    out_degree: Any
    adj: dict[Any, dict[Any, dict[int, dict[str, Any]]]]
    succ: dict[Any, dict[Any, dict[int, dict[str, Any]]]]
    pred: dict[Any, dict[Any, dict[int, dict[str, Any]]]]
    name: str
    ...
    def subgraph(self, nodes: Any) -> "MultiDiGraph": ...
    def edge_subgraph(self, edges: Any) -> "MultiDiGraph": ...
    def to_undirected(self) -> Graph: ...
    def to_directed(self) -> "MultiDiGraph": ...
    def update(self, edges: Any = None, nodes: Any = None) -> None: ...
    def number_of_edges_between(self, u: Any = None, v: Any = None) -> int: ...
    def clear(self) -> None: ...
    def clear_edges(self) -> None: ...
...
def efficiency(g: Graph, u: Any, v: Any) -> float: ...
def global_efficiency(g: Graph) -> float: ...
def local_efficiency(g: Graph) -> float: ...
def tree_broadcast_center(g: Graph) -> tuple[int, set[Any]]: ...
def tree_broadcast_time(g: Graph, node: Any = None) -> int: ...
...
def gn_graph(
    n: int, seed: Optional[int] = None, create_using: Any = None
) -> DiGraph: ...
def gnr_graph(
    n: int, p: float, seed: Optional[int] = None, create_using: Any = None
) -> DiGraph: ...
def gnc_graph(
    n: int, seed: Optional[int] = None, create_using: Any = None
) -> DiGraph: ...
...
def random_regular_graph(d: int, n: int, seed: int) -> Graph: ...
def powerlaw_cluster_graph(n: int, m: int, p: float, seed: int) -> Graph: ...
...
def all_triangles(g: Graph) -> list[tuple[Any, Any, Any]]: ...
def node_clique_number(g: Graph) -> dict[Any, int]: ...
def enumerate_all_cliques(g: Graph) -> list[list[Any]]: ...
def find_cliques_recursive(g: Graph) -> list[list[Any]]: ...
def chordal_graph_cliques(g: Graph) -> list[list[Any]]: ...
def chordal_graph_treewidth(g: Graph) -> int: ...
def make_max_clique_graph(g: Graph) -> Graph: ...
def ring_of_cliques(num_cliques: int, clique_size: int) -> Graph: ...

# Classic graph generators
def balanced_tree(r: int, h: int) -> Graph: ...
def barbell_graph(n1: int, n2: int) -> Graph: ...
def bull_graph() -> Graph: ...
def chvatal_graph() -> Graph: ...
def cubical_graph() -> Graph: ...
def desargues_graph() -> Graph: ...
def diamond_graph() -> Graph: ...
def dodecahedral_graph() -> Graph: ...
def frucht_graph() -> Graph: ...
def heawood_graph() -> Graph: ...
def house_graph() -> Graph: ...
def house_x_graph() -> Graph: ...
def icosahedral_graph() -> Graph: ...
def krackhardt_kite_graph() -> Graph: ...
def moebius_kantor_graph() -> Graph: ...
def octahedral_graph() -> Graph: ...
def pappus_graph() -> Graph: ...
def petersen_graph() -> Graph: ...
def sedgewick_maze_graph() -> Graph: ...
def tetrahedral_graph() -> Graph: ...
def truncated_cube_graph() -> Graph: ...
def truncated_tetrahedron_graph() -> Graph: ...
def tutte_graph() -> Graph: ...
def hoffman_singleton_graph() -> Graph: ...
def generalized_petersen_graph(n: int, k: int) -> Graph: ...
...
def tadpole_graph(m: int, n: int) -> Graph: ...
def turan_graph(n: int, r: int) -> Graph: ...
def windmill_graph(k: int, n: int) -> Graph: ...
def hypercube_graph(n: int) -> Graph: ...
def complete_bipartite_graph(n1: int, n2: int) -> Graph: ...
def complete_multipartite_graph(block_sizes: list[int]) -> Graph: ...
def grid_2d_graph(m: int, n: int) -> Graph: ...
def null_graph() -> Graph: ...
def trivial_graph() -> Graph: ...
def binomial_tree(n: int) -> Graph: ...
def full_rary_tree(r: int, n: int) -> Graph: ...
def circulant_graph(n: int, offsets: list[int]) -> Graph: ...
def kneser_graph(n: int, k: int) -> Graph: ...
def paley_graph(q: int) -> Graph: ...
def chordal_cycle_graph(n: int) -> Graph: ...
